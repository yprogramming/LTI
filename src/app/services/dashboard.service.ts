...
export class DashboardService {
  ...
  allPlaceLength() {
    ...
    return this.http.get(environment.SERVER_ADDRESS + '/api/dashboard/count', option);
  }
  ...
  allPlaceViews() {
    ...
    header.append('ltitoken',   token);
    const option: RequestOptions = new RequestOptions({headers: header});
    return this.http.get(environment.SERVER_ADDRESS + '/api/dashboard/current', option);
  }
